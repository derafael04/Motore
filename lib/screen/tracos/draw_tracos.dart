...
class TelaDrawTracos extends StatefulWidget {
  const TelaDrawTracos({super.key});

  @override
  State<TelaDrawTracos> createState() => _TelaDrawTracosState();
}

class _TelaDrawTracosState extends State<TelaDrawTracos> {
        ...
        child: Stack(
          children: [
            Positioned(
              ...
              right: 0,
              left: 0,
              child: SvgPicture.asset(NumberDraw().getSvgByTracados(index + 1),
